...
//3
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        /* when u double click on screen , it will set time = 0 which mean text on screen and speech will stoped auto ,
         and ready to return and take new text to turn it to speech */
